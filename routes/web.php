...
Route::group(['middleware' => ['get.menu']], function () {
    ...
    Route::group(['middleware' => ['role:admin']], function () {
        Route::resources([
            ...
            'healthcare' => 'HealthcareController',
            'package-healthcare' => 'PackageHealthcareController',
            'infrastructureBVTH' => 'InfrastructureBvthController',
            'albumsBVTH' => 'AlbumsBvthController',
            'videoBVTH' => 'VideoBvthController',
            'photoCatalogBVTH' => 'PhotoCatalogBvthController',
            'notifications' => 'NotifyController',
            'departmentBVTH' => 'DepartmentController',
            'doctorBVTH' => 'DoctorBvthController',
