...
<div class="c-sidebar-brand">
    <img class="c-sidebar-brand-full" src="{{ asset('frontEnd/img/favicon.ico') }}" alt="CoreUI Logo">
    <img class="c-sidebar-brand-minimized" src="{{ asset('frontEnd/img/favicon.ico') }}" alt="CoreUI Logo">
</div>
