...
@section('title')
<title>{{ !empty($healthcare->title) ? $healthcare->title : 'Gói khám sức khỏe cho doanh nghiệp' }}</title>
<meta name="title"
    content="{{ !empty($healthcare->meta_title) ? $healthcare->meta_title : 'Gói khám sức khỏe cho doanh nghiệp' }}" />
...
@section('og:type')
<meta property="og:type" content="{{ !empty($healthcare->title) ? $healthcare->title : 'Gói khám sức khỏe cho doanh nghiệp' }}">
<meta property="og:title" content="{{ !empty($healthcare->title) ? $healthcare->title : 'Gói khám sức khỏe cho doanh nghiệp' }}">
