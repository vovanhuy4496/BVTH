              ...
              <div class="col-sm-12 col-md-10 col-lg-8 col-xl-6">
                <div class="card">
                    <div class="card-header">
                      <i class="fa fa-align-justify"></i> {{ __('Thêm mới danh mục') }}</div>
                    <div class="card-body">
                        <form method="POST" action="{{ route('catalog-newspaper.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label>Tên danh mục</label>
                                <input class="form-control" type="text" placeholder="{{ __('Tên danh mục') }}" name="name" autofocus required>
                            </div>
