                    ...
                    <div class="card-body">
                        <form method="POST" action="/departmentBVTH/{{ $department->id }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control" type="text" placeholder="{{ __('Tên phòng ban') }}" name="name" value="{{ $department->name }}" autofocus>
                            </div>
                            
                            <div class="form-group row bvth-status">
                                <label class="margin-0-10-0-0">Trạng thái: </label>
                                <label style="width: 30px;" class="label-status margin-0-10-0-0">{{ $department->status == 1 ? 'Hiện' : 'Ẩn' }}</label>
                                <input type="checkbox"
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control" type="text" placeholder="{{ __('Vị trí hiển thị') }}" name="sort" autofocus required value="{{ $department->sort }}">
                            </div>
