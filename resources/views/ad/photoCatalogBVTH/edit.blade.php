                    ...
                    <div class="card-body">
                        <form method="POST" action="/photoCatalogBVTH/{{ $catalog->id }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control" type="text" placeholder="{{ __('Tên phòng ban') }}" name="name" value="{{ $catalog->name }}" autofocus>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <input class="form-control" type="text" placeholder="{{ __('Vị trí hiển thị') }}" name="sort" autofocus required value="{{ $catalog->sort }}">
                            </div>
