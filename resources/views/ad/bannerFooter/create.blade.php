            ...
            <div class="row">
              <div class="col-sm-12 col-md-10 col-lg-8 col-xl-6">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('ad-banner-footer.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <label>Tên</label>
                                <input class="form-control" type="text" placeholder="{{ __('Tên') }}" name="name" autofocus>
                            </div>
                            <div class="form-group row">
                                <label>Mô tả</label>
                                <input class="form-control" type="text" placeholder="{{ __('Mô tả') }}" name="describe" autofocus>
                            </div>
